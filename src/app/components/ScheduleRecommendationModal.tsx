            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-teal-500 focus:border-transparent text-center bg-white appearance-none"
                >
